...
class IntakeProgressObject: NSObject,NSCopying {
    
    func copy(with zone: NSZone? = nil) -> Any {
        let intakeProgressObject = IntakeProgressObject.init(proteinProgress: self.proteinProgress, calciumProgress: self.calciumProgress, totalFatProgress: self.totalFatProgress, sodiumProgress: self.sodiumProgress, vitaminCProgress: self.vitaminCProgress, vitaminAProgress: self.vitaminAProgress, progressMark: self.progressMark)
        return intakeProgressObject
    }
