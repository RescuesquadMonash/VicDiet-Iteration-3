...
class MeCell: UICollectionViewCell,UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    func setupViews(){
        ...
        collectionViewNestedFirst.topAnchor.constraint(equalTo: topAnchor, constant: 64).isActive = true
        ...
        collectionViewNestedFirst.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -50).isActive = true
