...
class FoodInMealCell: UITableViewCell {
    ...
    func setupCellView(){
        ...
        foodImageView.widthAnchor.constraint(equalTo: self.contentView.widthAnchor, multiplier: 0.2).isActive = true
        ...
        foodWeightLabel.widthAnchor.constraint(equalTo: self.contentView.widthAnchor, multiplier: 0.2).isActive = true
    }
}
