...
class MealTitleCell: UITableViewCell {
    ...
    func setupCellView(){
        ...
        mealImageView.topAnchor.constraint(equalTo: topAnchor, constant: self.frame.height*1.6).isActive = true
        mealImageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20).isActive = true
        ...
        mealNameTextField.topAnchor.constraint(equalTo: topAnchor, constant: self.frame.height*1.6).isActive = true
        mealNameTextField.leadingAnchor.constraint(equalTo: mealImageView.trailingAnchor, constant: 25).isActive = true
