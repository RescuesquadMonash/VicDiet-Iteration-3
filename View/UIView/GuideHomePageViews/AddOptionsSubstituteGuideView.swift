...
class AddOptionsSubstituteGuideView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        label.topAnchor.constraint(equalTo: topAnchor, constant: 64 + frame.height*0.05).isActive = true
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: 0, y: 64 + frame.height*0.42, width: frame.width, height: frame.height*0.15),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
