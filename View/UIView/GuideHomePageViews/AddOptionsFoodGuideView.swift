...
class AddOptionsFoodGuideView: UIView { 
    ...
    let label: UILabel = {
        ...
        label.text = "Adding food function enables you to add single food item to your today's food intake list."
    ...
    override init(frame: CGRect) {
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: 0, y: 64, width: frame.width, height: frame.height*0.15),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
