...
class IntakeListEditGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "You can delete any food item by clicking on the Edit button. When you  finish deleting, don't forget to click on the button again."
