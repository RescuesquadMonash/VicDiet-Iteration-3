...
class SearchingViewForMeal: UIView, UITableViewDelegate, UITableViewDataSource{
    ...
    override init(frame: CGRect) {
        ...
        tableView.register(NormalSearchResultCell.self, forCellReuseIdentifier: cellId)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath) as! NormalSearchResultCell
        ...
        if isSearching{
            ...
            cell.setupData(foodName: name, foodDetail: detail)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let foodDetailForMealTableViewController = FoodDetailForMealTableViewController()
        foodDetailForMealTableViewController.detailList = detailList
        foodDetailForMealTableViewController.fixedDimensionalArray = fixedDimensionalArray
        foodDetailForMealTableViewController.selectedFoodObject = filteredFixedDimensionalArray[indexPath.section].names[indexPath.row]
        foodDetailForMealTableViewController.searchForMealViewController = self.searchForMealViewController
        foodDetailForMealTableViewController.homePageController = self.homePageController
        detailList = [String]()
        let oldNavigationController = self.searchForMealViewController?.navigationController
        oldNavigationController?.pushViewController(foodDetailForMealTableViewController, animated: true)
