...
//    }
    ...
    override func viewDidLoad() {
        ...
        setupView()
        setupBottomMenu()
        searchMealButton.addTarget(self, action: #selector(handleSearchMeal), for: .touchUpInside)
        addAsMealButton.addTarget(self, action: #selector(handleAddAsMeal), for: .touchUpInside)
    ...
    @objc private func handleSearchMeal(){
        ...
        mealPlanOverviewView.setupRadarChartData(protein: Double(Int(intakeProgressAfterSearch.proteinProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.proteinProgress)!*100, calcium: Double(Int(intakeProgressAfterSearch.calciumProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.calciumProgress)!*100, fat: Double(Int(intakeProgressAfterSearch.totalFatProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.totalFatProgress)!*100, sodium: Double(Int(intakeProgressAfterSearch.sodiumProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.sodiumProgress)!*100, vitaminC:Double(Int(intakeProgressAfterSearch.vitaminCProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.vitaminCProgress)!*100, vitaminA:Double(Int(intakeProgressAfterSearch.vitaminAProgress*1000))*0.001/(homePageController?.intakeRestProgressObject.vitaminAProgress)!*100)
        mealPlanOverviewView.setupBothSidesData(protein: Double(Int(intakeProgressAfterSearch.proteinProgress*1000))*0.001, calcium: Double(Int(intakeProgressAfterSearch.calciumProgress*1000))*0.001, fat: Double(Int(intakeProgressAfterSearch.totalFatProgress*1000))*0.001, sodium: Double(Int(intakeProgressAfterSearch.sodiumProgress*1000))*0.001, vitaminC: Double(Int(intakeProgressAfterSearch.vitaminCProgress*1000))*0.001, vitaminA: Double(Int(intakeProgressAfterSearch.vitaminAProgress*1000))*0.001)
    }
    @objc private func handleAddAsMeal(){
//        self.mealObjectList.append(MealObject(foodObjectList: mealPlanArray))
...
//        foodOfMealController.mealTag = self.mealObjectList.count - 1
//        oldNavigationController?.pushViewController(foodOfMealController, animated: true)
        ...
        mealListController.mealObjectList = self.mealObjectList
        mealListController.mealPlanResultController = self
