...
//        }
    ...
    func markCalculator(oldFoodItem: FoodObject, newFoodItem: FoodObject, newQuantity: Double) -> (FoodObject){
        ...
        newFoodItem.match = Double(Int((1 - newFoodItem.mark/(proteinStandard + calciumStandard + totalFatStandard + sodiumStandard + vitaminCStandard + vitaminADStandard))*1000))/10
        return newFoodItem
    }
