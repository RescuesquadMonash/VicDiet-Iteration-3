...
class NormalSearchResultCell: UITableViewCell {
    ...
    let foodImageView: UIImageView = {
        ...
        mealImageView.image = UIImage(named: "icon_food")
    ...
    func setupViews(){
        ...
        foodImageView.topAnchor.constraint(equalTo: topAnchor, constant: 0).isActive = true
        foodImageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 0).isActive = true
        foodImageView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: 0).isActive = true
        foodImageView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 0.2).isActive = true
